...
function Get-DetectedCiVersion([string] $PropsOrCsprojPath, [switch] $Release) {
    $versionPrefix = [version](XmlPeek $PropsOrCsprojPath '/Project/PropertyGroup/Version/text()')
