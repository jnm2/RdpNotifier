...
$versionInfo = Get-DetectedCiVersion 'src/RdpNotifier/RdpNotifier.csproj' -Release:$Release
...
dotnet publish .\src\RdpNotifier --no-build --output $binDir /bl:$logsDir\publish.binlog @dotnetArgs
if ($LastExitCode) { exit 1 }
